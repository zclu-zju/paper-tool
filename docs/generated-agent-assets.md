...
The generator parses `deep-paper-search-agent-system-design.md` and writes 84 agent TOML files plus 84 project prompt files. Each project agent prompt is expected to be at least 1000 words.
