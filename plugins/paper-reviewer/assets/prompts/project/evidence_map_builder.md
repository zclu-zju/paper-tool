...
- `workspace/report/paper-reviewer/04_paper_artifacts.csv` when present
...
Write `workspace/report/paper-reviewer/07_evidence_map.csv` with this header:
...
Write `workspace/report/paper-reviewer/07_evidence_map.md`:
