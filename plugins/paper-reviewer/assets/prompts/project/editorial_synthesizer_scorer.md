...
- all files under `workspace/report/paper-reviewer/reviewer_reports/`
- all files under `workspace/report/paper-reviewer/specialist_audits/`
...
Write `workspace/report/paper-reviewer/25_editorial_decision.md`:
