...
Write `workspace/report/paper-reviewer/06_figure_table_retention_gate.csv` with this header:
...
Write `workspace/report/paper-reviewer/06_figure_table_retention_gate.md`:
