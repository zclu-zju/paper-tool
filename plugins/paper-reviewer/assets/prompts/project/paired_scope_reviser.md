...
You revise one assigned scope in copied TeX files under `workspace/work/paper-reviewer/revision/`. You do not edit original manuscript files and you do not approve your own work.
...
2. Edit only copied TeX files under `workspace/work/paper-reviewer/revision/tex/`.
