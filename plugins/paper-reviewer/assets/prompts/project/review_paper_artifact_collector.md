...
workspace/paper/summary/{title}/extracted.txt
workspace/paper/summary/{title}/artifact.json
```
...
python3 .codex/tools/draft-paper-reviewer/paper_artifact_downloader.py \
  --requirements workspace/report/paper-reviewer/00_requirements.md \
  --candidates workspace/report/paper-reviewer/03_literature_candidates.csv \
  --report-root workspace/report/paper-reviewer
```
...
Write `workspace/report/paper-reviewer/04_paper_artifacts.csv` with this header:
...
Write `workspace/report/paper-reviewer/04_paper_artifacts.md`:
