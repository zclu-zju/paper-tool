...
- downloaded PDFs under `workspace/paper/pdf/{title}/`, TeX/source archives under `workspace/paper/tex/{title}/`, and extracted text or metadata under `workspace/paper/summary/{title}/`
...
Write `workspace/report/paper-reviewer/05_downloaded_paper_conventions.csv` with this header:
...
Write `workspace/report/paper-reviewer/05_downloaded_paper_conventions.md`:
