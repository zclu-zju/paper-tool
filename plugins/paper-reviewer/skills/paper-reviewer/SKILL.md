...
```bash
python3 plugins/paper-reviewer/scripts/install_project_agents.py --repo .
```
...
- one or more entries in `workspace/report/paper-reviewer/07_evidence_map.csv`;
