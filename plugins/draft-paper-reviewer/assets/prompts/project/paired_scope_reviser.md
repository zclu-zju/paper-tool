...
5. Use related papers as style and structure exemplars only when evidence-map rows support that use.
...
8. Report changed files, target locations, and a concise change summary for the ledger.

## Output For Coordinator

Return a change record suitable for insertion into `revision_ledger.jsonl`:
