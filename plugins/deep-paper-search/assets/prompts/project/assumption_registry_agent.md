...
9. Write `workspace/work/deep-paper-search/agent_artifacts/intent_definition_boundaries/assumption_registry_agent.md` only when this invocation creates a reusable artifact beyond the ledger row; write `workspace/work/deep-paper-search/agent_artifacts/intent_definition_boundaries/assumption_registry_agent.json` when records should be parsed by another stage.
