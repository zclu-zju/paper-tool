...
- What exact evidence proves that the concept definition output is needed in this run rather than merely convenient?
- Which input records, stage artifacts, or prior decisions directly support each claim made by concept_definition_agent?
- What would be the concrete search failure if this agent skipped its work or produced a shallow answer?
- Which downstream agent will consume the concept definition table, and in what structured form must that consumer receive it?
...
artifact_type: "concept definition table"
records: []
assumptions: []
uncertainties: []
