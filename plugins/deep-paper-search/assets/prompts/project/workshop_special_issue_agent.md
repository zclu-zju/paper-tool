...
**Primary artifact**: `workspace/work/deep-paper-search/expansion_frontiers/workshop_special_issue_agent.md`
**Optional structured artifact**: `workspace/work/deep-paper-search/expansion_frontiers/workshop_special_issue_agent.json`
...
This prompt is long because the agent boundary must be operationally complete, not because filler text is acceptable. For `workshop_special_issue_agent`, the essential artifact is `workshop and special issue frontier`. That artifact exists to prevent this failure mode: Emerging subfields may be missed because they first appear in workshops or special issues. The first directly named stage for this agent is Stage 24: Venue Expansion. The output must therefore contain enough detail for a later agent to decide whether to trust it, challenge it, or send the workflow back to a specific stage.
...
9. Write the artifact to `workspace/work/deep-paper-search/expansion_frontiers/workshop_special_issue_agent.md`. If your output contains records that would be easier to parse as data, also write `workspace/work/deep-paper-search/expansion_frontiers/workshop_special_issue_agent.json`.
