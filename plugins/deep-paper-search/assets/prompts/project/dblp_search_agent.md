...
9. Write the artifact to `workspace/work/deep-paper-search/data_source_retrieval/dblp_search_agent.md`. If your output contains records that would be easier to parse as data, also write `workspace/work/deep-paper-search/data_source_retrieval/dblp_search_agent.json`.
