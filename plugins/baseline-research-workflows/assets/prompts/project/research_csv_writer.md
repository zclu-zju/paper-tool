...
7. If paper artifact retrieval was requested, merge PDF/TeX download paths, compile status, and compiled PDF paths from `paper_artifacts.csv`.
8. Write `final_papers.csv`.
9. Write `research_summary.md`.
...
```csv
method_type,dataset_or_benchmark,metric_or_evaluation,scope_match,selection_reason,clone_url,license,pdf_url,tex_source_url,compiler_used,notes
```
