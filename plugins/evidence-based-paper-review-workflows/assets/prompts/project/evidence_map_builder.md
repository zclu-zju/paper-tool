...
- `workspace/evidence_paper_review/reports/paper_artifacts.csv` when present
...
Write `workspace/evidence_paper_review/reports/evidence_map.csv` with this header:
...
Write `workspace/evidence_paper_review/reports/evidence_map.md`:
